...
class KMeansClustering:
    ...
    def elbow_plot(self,data):
        ...
        try:
            ...
            #  It is calculated by measuring the distance between each data point and its centroid, squaring 
            # this distance, and summing these squares across one cluster. A good model is one with low inertia 
            # AND a low number of clusters ( K ).
                wcss.append(kmeans.inertia_)  ## inertia_ is WCSS(within cluster summation of square)
            ...
            return self.kn.knee  ## .knee se optimum k ki value fetch
